      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="mt-12 animate-in fade-in slide-in-from-bottom-3 duration-700">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block dark:hidden hover:scale-[1.02] transition-transform duration-200"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1164901&theme=light&t=1780739671462"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden dark:inline-block hover:scale-[1.02] transition-transform duration-200"
          >
            <img
